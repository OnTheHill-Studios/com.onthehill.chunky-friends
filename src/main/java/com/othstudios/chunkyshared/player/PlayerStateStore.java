package com.othstudios.chunkyshared.player;
...
/**
 * Loads and saves per-player pregeneration state to {@code <world>/data/chunkyshared_state.json}.
 */
public final class PlayerStateStore
{
    private static final Logger LOGGER = LoggerFactory.getLogger(PlayerStateStore.class);
    private static final String STATE_FILE_NAME = "chunkyshared_state.json";
