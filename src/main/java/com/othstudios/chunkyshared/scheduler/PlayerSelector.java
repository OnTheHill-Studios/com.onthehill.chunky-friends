...
public final class PlayerSelector
{
     ...
     */
    public static Optional<PlayerPregenState> selectNext(final Collection<PlayerPregenState> states, final long nowEpochMillis, final ChunkySharedConfig config)
    {
