...
import com.othstudios.chunkyshared.player.PlayerStateStore;
...
public final class PregenScheduler
{
    ...
    private final ChunkySharedConfig _config;
     ...
     */
    public PregenScheduler(final ChunkyGateway chunkyGateway, final ChunkySharedConfig config)
    {
