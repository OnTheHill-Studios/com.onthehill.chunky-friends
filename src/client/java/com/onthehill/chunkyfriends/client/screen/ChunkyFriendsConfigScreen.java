...
public final class ChunkyFriendsConfigScreen extends Screen
{
     ...
     * {@code /chunkyfriends gui}, which already sends one alongside the open instruction) could be stale.
    ...
    protected void init()
    {
        ...
        _ringCountBox = rows.addChild(new EditBox(font, FIELD_WIDTH, FIELD_HEIGHT, Component.translatable("gui.chunky-friends.config.ring_count")));
        ...
        _maxRadiusBox = rows.addChild(new EditBox(font, FIELD_WIDTH, FIELD_HEIGHT, Component.translatable("gui.chunky-friends.config.max_radius")));
        ...
        _curveButton = rows.addChild(CycleButton.booleanBuilder(
                        ...
                        _quadratic)
                .create(Component.translatable("gui.chunky-friends.config.curve"), (button, value) -> _quadratic = value));

        rows.addChild(Button.builder(Component.translatable("gui.chunky-friends.config.save"), button -> onSave()).build());
        rows.addChild(Button.builder(Component.translatable("gui.chunky-friends.config.cancel"), button -> onClose()).build());
